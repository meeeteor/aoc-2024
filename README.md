...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `46.2µs` | `59.8µs` |
| [Day 2](./src/bin/02.rs) | `1.1ms` | `2.3ms` |
| [Day 3](./src/bin/03.rs) | `268.0µs` | `242.0µs` |
| [Day 4](./src/bin/04.rs) | `544.2µs` | `134.2µs` |
| [Day 5](./src/bin/05.rs) | `1.8ms` | `2.1ms` |
